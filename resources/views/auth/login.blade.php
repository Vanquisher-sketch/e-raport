        ...
        <div class="content-4-1 d-flex flex-column align-items-center h-100 flex-lg-row"
            ...
            <div id="page" class="d-flex mx-0 align-items-left justify-content-left width-right mx-lg-0">
                <div class="right mx-lg-0 mx-auto">
                    ...
                    <h3 class="title-text text-center mt-xs-3">Login E-RAPORT K-13</h3>
                    <p class="caption-text text-center">
                        Login menggunakan akun terdaftar
                    </p>
                                        <form style="margin-top: 1.5rem" action="https://eraportk13.vanzdev.com/login" method="POST">
                        <input type="hidden" name="_token" value="JGwiIfdreK1XKBWBMHpWEazTGjbf9EP0lZLf0Gep">                        <div style="margin-bottom: 1.75rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0" value="" type="text" name="username" id="username"
